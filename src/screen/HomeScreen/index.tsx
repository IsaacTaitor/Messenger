...
import {addMessage, removeMessage} from '../../redux/messages/messagesActions';
...
import {
	...
	deleteAttachedFile,
	clearAttachedFiles
} from '../../redux/attachedFiles/attachedFilesActions';
...
class HomeScreen extends React.Component<HomeScreenProps> {
	...
	render(): React.ReactElement {
		const {
			messagesStore, attachedFilesStore, modalViewImageStore,
			clearAttachedFiles, changeAttachedFile, addMessage, removeMessage, addAttachedFile, deleteAttachedFile, openModal, closeModal
		} = this.props;
		return (
			<>
				<div className="background">
					...
					<div className="container">
						<div className="content">
							<MessageList messages={messagesStore} openModal={openModal} removeMessage={removeMessage}/>
							<MessageDND
				...
				<ModalViewImage modalViewImageStore={modalViewImageStore} closeModal={closeModal}
												changeAttachedFile={changeAttachedFile}/>
			</>
		);
	}
}
